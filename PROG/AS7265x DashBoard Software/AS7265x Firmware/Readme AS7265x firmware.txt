...
Changes in pin configrations
	...
	See the schematics as PDF for generation 1 and 2 in the directories for firmware "~firmware for AS7265x generation x".

	For newer hardware designs of ams or customized designs which considers the pin swapping, please use the binary files .bin without extension "_moonlight"
